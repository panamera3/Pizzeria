        ...
        <div className={'sections'}>
          <section>
            ...
            <div className={'personal-info-block'}>
              <p>
                Email
                <svg className={'show-info'} xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                  <g clip-path="url(#clip0_14_254)">
                    <path d="M10 7.5C9.75277 7.5 9.5111 7.42669 9.30554 7.28934C9.09998 7.15199 8.93976 6.95676 8.84515 6.72835C8.75054 6.49995 8.72579 6.24861 8.77402 6.00614C8.82225 5.76366 8.9413 5.54093 9.11612 5.36612C9.29093 5.1913 9.51366 5.07225 9.75614 5.02402C9.99861 4.97579 10.2499 5.00054 10.4784 5.09515C10.7068 5.18976 10.902 5.34998 11.0393 5.55554C11.1767 5.7611 11.25 6.00277 11.25 6.25C11.25 6.58152 11.1183 6.89946 10.8839 7.13388C10.6495 7.3683 10.3315 7.5 10 7.5Z" fill="#444444"/>
                    <path d="M10 18.125C8.39303 18.125 6.82214 17.6485 5.486 16.7557C4.14985 15.8629 3.10844 14.594 2.49348 13.1093C1.87852 11.6247 1.71762 9.99099 2.03112 8.4149C2.34463 6.8388 3.11846 5.39106 4.25476 4.25476C5.39106 3.11846 6.8388 2.34463 8.4149 2.03112C9.99099 1.71762 11.6247 1.87852 13.1093 2.49348C14.594 3.10844 15.8629 4.14985 16.7557 5.486C17.6485 6.82214 18.125 8.39303 18.125 10C18.125 12.1549 17.269 14.2215 15.7452 15.7452C14.2215 17.269 12.1549 18.125 10 18.125ZM10 3.125C8.64026 3.125 7.31105 3.52822 6.18046 4.28365C5.04987 5.03908 4.16868 6.11281 3.64833 7.36906C3.12798 8.6253 2.99183 10.0076 3.2571 11.3412C3.52238 12.6749 4.17716 13.8999 5.13864 14.8614C6.10013 15.8228 7.32514 16.4776 8.65876 16.7429C9.99238 17.0082 11.3747 16.872 12.631 16.3517C13.8872 15.8313 14.9609 14.9501 15.7164 13.8195C16.4718 12.689 16.875 11.3597 16.875 10C16.875 8.17664 16.1507 6.42796 14.8614 5.13864C13.5721 3.84933 11.8234 3.125 10 3.125Z" fill="#444444"/>
                    <path d="M10 15C9.66848 15 9.35054 14.8683 9.11612 14.6339C8.8817 14.3995 8.75 14.0815 8.75 13.75V10C8.75 9.66848 8.8817 9.35054 9.11612 9.11612C9.35054 8.8817 9.66848 8.75 10 8.75C10.3315 8.75 10.6495 8.8817 10.8839 9.11612C11.1183 9.35054 11.25 9.66848 11.25 10V13.75C11.25 14.0815 11.1183 14.3995 10.8839 14.6339C10.6495 14.8683 10.3315 15 10 15Z" fill="#444444"/>
                  </g>
                  <defs>
            ...
            <div style={{marginBottom: 29}}>
              ...
              Я хочу получать SMS-рассылки для участия в акциях и розыгрышах.
            </div>
              ...
              <div className={'btns'}>
                ...
                <Modal active={modalActive} setActive={setModalActive}>
                  <div className={'add-card'}>
                    ...
                    <section className={'add-card-btns'}>
                      <div className={'back-to-pa-btn'} onClick={() => setModalActive(false)}>
                        Вернуться в личный кабинет
                      </div>
